...
const BlogTongHopPhim: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t('BLOG_MOVIES_SUMMARY_TITLE')}</title>
      </Helmet>
      ...
      <Container>
        ...
        <Breadcrumb>
          ...
          <Separator>&gt;</Separator>
          <li className='active'>{t('BLOG_MOVIES_SUMMARY')}</li>
        </Breadcrumb>

        {/* Header */}
        <HeaderSection>
          <h1>{t('BLOG_MOVIES_SUMMARY')}</h1>
          <p>{t('BLOG_MOVIES_SUMMARY_DESC')}</p>
        </HeaderSection>
