...
const Section = styled.section`margin: 40px 0; text-align: center;`;
const Heading = styled.h2`font-size: 28px; font-weight: 700; margin-bottom: 20px; color: ${theme.colors.textPrimary};`;
...
`;
const Status = styled.div<{ active: boolean }>`font-size: 14px; margin-top: 4px; font-weight: 600; color: ${props => (props.active ? '#69f0ae' : '#ff5252')};`;