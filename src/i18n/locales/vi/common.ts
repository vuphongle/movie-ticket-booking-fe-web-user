const common = {
  ...
  home_subtitle: "Khám phá các bộ phim mới nhất và đặt vé ngay hôm nay. Chúng tôi sẽ đem đến cho bạn những trải nghiệm tuyệt vời nhất khi đặt vé xem phim ở trang này :)((.",
  ...
  register_success_message: "Đăng ký thành công. Vui lòng kiểm tra email để xác nhận tài khoản.",
  ...
  REGISTER_ACCOUNT_NOT_ACTIVATED: "Email đã tồn tại nhưng chưa kích hoạt. Vui lòng kiểm tra email để kích hoạt tài khoản.",
